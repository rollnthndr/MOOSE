...
-- 
-- @field Wrapper.Positionable#POSITIONABLE cargoobject The cargo POSITONABLE object.
-- @field #number weight Weight of cargo in kg.
-- 
...
-- @param Wrapper.Positionable#POSITIONABLE CargoObject The cargo POSITIONABLE object, e.g. GROUP or STATIC.
-- @return #KARGOBASE self
function KARGOBASE:New(CargoObject)
  ...
  self.cargoname=CargoObject:GetName()
      
  -- Set some string id for output to DCS.log file.
  self.lid=string.format("KARGOBASE %s | ", tostring(self.cargoname))
  ...
  --- Triggers the FSM event "Spawned".
  -- @function [parent=#KARGOBASE] Spawned
  -- @param #KARGOBASE self

  --- Triggers the FSM event "Spawned" after a delay.
  -- @function [parent=#KARGOBASE] __Spawned
  -- @param #KARGOBASE self
  ...
  if self.cargoobject:IsAlive() then
    env.info("FF spawned",showMessageBox)
    self:Spawned()
  end
...
--- Set cargo weight.
-- @param #KARGOBASE self
-- @param #number Weight Weight of the cargo in kg.
-- @return #KARGOBASE self
function KARGOBASE:SetWeight(Weight)
  self.weight=Weight
  return self
end
...
--- Get cargo weight.
-- @param #KARGOBASE self
-- @return #number Weight of the cargo in kg.
function KARGOBASE:GetWeight()
  return self.weight
end
